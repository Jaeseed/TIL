    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=50, verbose_name='Name of User')),
                ('profile_photo', models.ImageField(blank=True, upload_to='')),
                ('website', models.URLField(blank=True)),
                ('bio', models.TextField(blank=True)),
                ('email', models.CharField(blank=True, max_length=50)),
                ('phone_number', models.CharField(blank=True, max_length=50)),
                ('gender', models.CharField(blank=True, choices=[('M', 'Male'), ('F', 'Female'), ('C', 'Custom')], max_length=50)),
